package DDS.team22.ClosestPair;
...
public class ClosestPair {
	public static void main(String[] args) throws IOException {
		...
		SparkConf conf = new SparkConf().setAppName("Group22-Closest Pair");
		...
		JavaRDD<PointDouble> FinalClosetPairList = localPointsList
				.mapPartitions(new FlatMapFunction<Iterator<PointDouble>, PointDouble>() {
