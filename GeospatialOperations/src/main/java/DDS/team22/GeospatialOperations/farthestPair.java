...
public class farthestPair 
{
	...
	public static void getFarthestPoints(String inputFile, String outputDir, JavaSparkContext sc) throws IOException
    {
    	...
    	String coordinates = Helper.ConvexHull(sc, inputFile);
    	String[] cor_arr = coordinates.split("\n");
    	List<String> cor_list = Arrays.asList(cor_arr);
    	...
    	sc.parallelize(pts).distinct().repartition(1).saveAsTextFile(outputDir);
